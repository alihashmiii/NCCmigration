...
for timeCtr=1:skip:numTsteps
    ...
    make_plot(cells_save{timeCtr},cellsFollow{timeCtr},xlat_save{timeCtr},ylat_save{timeCtr},ca_save{timeCtr},filopodia_save{timeCtr},numFilopodia,attach_save{timeCtr},cellRadius,filolength,sensingAccuracy,1,caCmap,0);
...
%     ylim([-50,120+50])
    ...
    title(['Cell migration at time = ' num2str(t_save(timeCtr),'%2.2f') ' hours with '  ...
        ...
        nnz(cellsFollow{timeCtr}==0)])) ' leaders.'],'FontSize',23)

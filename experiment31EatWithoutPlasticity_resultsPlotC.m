...
for followFracCtr = length(followFracValues):-1:1
    ...
    for repCtr = 1:numRepeats
        loadInfo = ['experiment31Eat/exp31_followFrac_' num2str(followerFraction,precision) ...
        ...
        try % sometimes we get corrupt files, which crashes the script
            ...
            experiment31EatWithoutPlasticity; % recreate the missing results file
...
filename = 'manuscripts/subpopulations/figures/resultsFigSEatC';

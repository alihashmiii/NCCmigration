...
dateString = '2013_06_29'; % for the folder name to save all results in, even if simulations actually run over multiple days or are repeated on another day

totalTime = tic;
for repCtr = 1:numRepeats
    
    input{repCtr}.time = 18; % duration of each run, simulation time in hours
    input{repCtr}.numFilopodia = [2,2];

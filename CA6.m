...
follow_perc = 0.7;        % proportion of cells that are followers (0<=follow_per<=1)
...
%% ca_solve parameters %%
diffus = 0.02888;               % chemoattractant diffusivity
...
elseif convert_type == 2
    ...
    num_directions = 0.25; % number of directions needed to be better to maintain a leader profile (convert type 2)
else
    num_steps=[];
    num_directions=[];
end

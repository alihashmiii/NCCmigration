...
elasticityEatWidth = (leaderMMDirectionality(21) - leaderMMDirectionality(20))/leaderMMDirectionality(1)/(2 - 1/2);
...
elasticityEatWidth = (followerMMDirectionality(21) - followerMMDirectionality(20))/followerMMDirectionality(1)/(2 - 1/2);
...
elasticityEatWidth = (leaderMMSpeed(21) - leaderMMSpeed(20))/leaderMMSpeed(1)/(2 - 1/2);
...
elasticityEatWidth = (followerMMSpeed(21) - followerMMSpeed(20))/followerMMSpeed(1)/(2 - 1/2);

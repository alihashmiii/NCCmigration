...
sigFig = figure;
subplot(2,1,1)
plot(timeData(2:10),normExpression(2:10,allSigIdcs),'Color',[0.5 0.5 0.5])
hold on
plot(timeData(2:10),mean(normExpression(2:10,allSigIdcs),2),'m','LineWidth',3)
set(gca,'ytick',0:1:7,'xtick',0:30:90)
ylim([0 3])
xlabel('time (min)')
ylabel('relative expression')
subplot(2,1,2)
plot(timeData(10:end),normExpression(10:end,allSigIdcs),'Color',[0.5 0.5 0.5])
hold on
plot(timeData(10:end),mean(normExpression(10:end,allSigIdcs),2),'g','LineWidth',3)

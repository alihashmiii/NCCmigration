...
caGrad = gradient(caProfile,xlat_save)*filolength;
caCutOffIndcs = caGrad./sqrt(caProfile) < sensingAccuracy;
...
set(H3(3),'FaceColor','y'), set(H3(2),'FaceColor','w'), set(H3(1),'FaceColor',[0.5 0.5 0.5])

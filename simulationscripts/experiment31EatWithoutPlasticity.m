function experiment31EatWithoutPlasticity
...
for followerFraction = [0, 1]
    ...
    for sensingAccuracy = 0.1
        ...
        for repCtr = 1:numReps
            input.saveInfo = ['experiment31Eat/exp31_followFrac_' num2str(followerFraction,precision) ...
                '_sensingAcc_' num2str(sensingAccuracy) ...
                    '_Eat_' num2str(input.eatRate,precision) '_Run_' num2str(repCtr)];

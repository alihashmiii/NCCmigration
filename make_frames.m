...
for j=1:length(frames)
    ...
    if (experiment==4)||(experiment==5)
        make_plot(cells_save{k},cells_follow_save{k},xlat_save{k},ylat_save{k},ca_save{k},filopodia_save{k},num_filopodia,attach_save{k},cell_radius,edge,barrier(k),experiment)
    else
        make_plot(cells_save{k},cells_follow_save{k},xlat_save{k},ylat_save{k},ca_save{k},filopodia_save{k},num_filopodia,attach_save{k},cell_radius,edge,[],experiment)
    end
    if growing_domain==0
        xlim([0,300])
    end

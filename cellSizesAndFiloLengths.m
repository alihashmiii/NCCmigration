...
set(gca,'Ytick',0:5)
hold on
plot(mean(cellSizes)*[1 1], [0 5], 'r-')
plot(median(cellSizes)*[1 1], [0 5], 'r--')
xlabel('s/\mum')
ylabel('n')
...
hist(filopodiaAll)
hold on
plot(mean(filopodiaAll)*[1 1], [0 80], 'r-')
plot(median(filopodiaAll)*[1 1], [0 80], 'r--')
xlabel('l/\mum')
ylabel('n')
...
filename = ['manuscripts/subpopulations/figures/FigS4'];

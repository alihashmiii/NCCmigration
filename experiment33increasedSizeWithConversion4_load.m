    ...
    for followerFraction = [0, 1]
        ...
        for num_stepsCtr = 1:length(num_stepsValues)
            ...
            for eatRateCtr = 1:length(eatRateValues)
                ...
                title(['Exp3.3: leadFrac=' num2str(actualLeaderFraction(paramCtr),precision) ', eatRate=' num2str(eatRate) ', followDefault=' num2str(followerFraction) ', num_steps=' num2str(num_steps) ', insert_step=' num2str(insert_step) ])
                % save plot
                ...
                if eatRateCtr==1&&num_stepsCtr==1
                    title(['Exp3.3: followDefault=' num2str(followerFraction) ', leadFrac=' num2str(actualLeaderFraction(paramCtr),precision) ', insert_step=' num2str(insert_step)])
                ...
                if num_stepsCtr==length(num_stepsValues)
                    title(['Exp3.3: eatRate=' num2str(eatRate) ', followDefault=' num2str(followerFraction) ', tstep=' num2str(tstep,precision) ', insert_step=' num2str(insert_step)])
        ...
        filename = ['results/experiment33/figures/exp33_defaultFollow_' num2str(followerFraction) ...

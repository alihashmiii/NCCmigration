...
elasticityLeadSpeed = (meanNumCells(3) - meanNumCells(2))/meanNumCells(1)/(1.2 - 1/1.2);
elasticityFollowSpeed = (meanNumCells(5) - meanNumCells(4))/meanNumCells(1)/(1.2 - 1/1.2);
...
elasticityDiffus = (meanNumCells(15) - meanNumCells(14))/meanNumCells(1)/(100 - 1/100);
elasticityChi = (meanNumCells(17) - meanNumCells(16))/meanNumCells(1)/(100 - 1/100);
...
labels = {'reference', 'leadSpeed', ['e = ' num2str(elasticityLeadSpeed)], 'followSpeed',['e = '  num2str(elasticityFollowSpeed)], ...
    'numFilopodia [5;1]', 'numFilopodia [7;2]', 'numFilopodia [6;1]', 'numFilopodia [6;3]', ...
...
% parameters with experimental reference values
elasticityLeadSpeed = (leaderMMDirectionality(3) - leaderMMDirectionality(2))/leaderMMDirectionality(1)/(1.2 - 1/1.2);
elasticityFollowSpeed = (leaderMMDirectionality(5) - leaderMMDirectionality(4))/leaderMMDirectionality(1)/(1.2 - 1/1.2);
...
% parameters without experimental reference values
elasticityDiffus = (leaderMMDirectionality(15) - leaderMMDirectionality(14))/leaderMMDirectionality(1)/(100 - 1/100);
elasticityChi = (leaderMMDirectionality(17) - leaderMMDirectionality(16))/leaderMMDirectionality(1)/(100 - 1/100);
...
% parameters with experimental reference values
elasticityLeadSpeed = (followerMMDirectionality(3) - followerMMDirectionality(2))/followerMMDirectionality(1)/(1.2 - 1/1.2);
elasticityFollowSpeed = (followerMMDirectionality(5) - followerMMDirectionality(4))/followerMMDirectionality(1)/(1.2 - 1/1.2);
...
% parameters without experimental reference values
elasticityDiffus = (followerMMDirectionality(15) - followerMMDirectionality(14))/followerMMDirectionality(1)/(100 - 1/100);
elasticityChi = (followerMMDirectionality(17) - followerMMDirectionality(16))/followerMMDirectionality(1)/(100 - 1/100);
...
% parameters with experimental reference values
elasticityLeadSpeed = (leaderMMSpeed(3) - leaderMMSpeed(2))/leaderMMSpeed(1)/(1.2 - 1/1.2);
elasticityFollowSpeed = (leaderMMSpeed(5) - leaderMMSpeed(4))/leaderMMSpeed(1)/(1.2 - 1/1.2);
...
% parameters without experimental reference values
elasticityDiffus = (leaderMMSpeed(15) - leaderMMSpeed(14))/leaderMMSpeed(1)/(100 - 1/100);
elasticityChi = (leaderMMSpeed(17) - leaderMMSpeed(16))/leaderMMSpeed(1)/(100 - 1/100);
...
% parameters with experimental reference values
elasticityLeadSpeed = (followerMMSpeed(3) - followerMMSpeed(2))/followerMMSpeed(1)/(1.2 - 1/1.2);
elasticityFollowSpeed = (followerMMSpeed(5) - followerMMSpeed(4))/followerMMSpeed(1)/(1.2 - 1/1.2);
...
% parameters without experimental reference values
elasticityDiffus = (followerMMSpeed(15) - followerMMSpeed(14))/followerMMSpeed(1)/(100 - 1/100);
elasticityChi = (followerMMSpeed(17) - followerMMSpeed(16))/followerMMSpeed(1)/(100 - 1/100);
